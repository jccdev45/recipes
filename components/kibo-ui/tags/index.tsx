...
export const TagsTrigger = ({
  ...
  const hasValue = Children.toArray(children).some(Boolean)
...
export const TagsContent = ({
  ...
  const resolvedWidth = width ? `${width}px` : undefined
  ...
  return (
    <PopoverContent
      ...
      style={{
        width: resolvedWidth,
        minWidth: resolvedWidth ?? "var(--radix-popover-trigger-width)",
        ...style,
      }}
      {...props}
    >
